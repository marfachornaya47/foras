...
<head>
    ...
    <title>Стенды испытательные/обучающие по профессиям</title>
...
<body>
    ...
    $sql = "SELECT * FROM product_cards where category = 'Стенды испытательные/обучающие по профессиям'";
    ...
    if (mysqli_num_rows($resultset) > 0) { ?>
        ...
        <div class="uk-container uk-margin-top">
            ...
            <ul class="uk-breadcrumb">
                ...
                <li><a href="../pages/stends.php">Стенды испытательные/обучающие по профессиям</a></li>
            </ul>
